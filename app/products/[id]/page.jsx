...
async function getUSer(id) {
  ...
  return (
    <>
    <h1 className="my-8 text-base font-semibold leading-7 text-indigo-600 text-center text-[24px]">Product details</h1>
<div class="bg-white">
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
    ...
    <div class="lg:max-w-lg lg:self-end">
        ...
        <ol role="list" class="flex items-center space-x-2">
          <li>
            <div class="flex items-center text-sm">
              <a href="#" class="font-medium text-gray-500 hover:text-gray-900">{data.category}</a>
      ...
      <section aria-labelledby="information-heading" class="mt-4">
        ...
        <div class="flex items-center">
          <p class="text-lg text-gray-900 sm:text-xl">$ {data.price}</p>
          ...
          <div class="ml-4 border-l border-gray-300 pl-4">
            ...
            <div class="flex items-center">
              ...
              <p class="ml-2 text-sm text-gray-500">{data.rating.rate} stars</p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-6 flex items-center">
          ...
          <p class="ml-2 text-sm text-gray-500">{data.rating.count} In stock and ready to ship</p>
        </div>
      </section>
    </div>
    ...
    <div class="mt-10 lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
      <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg">
        <Image width={400} height={400} src={data.image} alt="Model wearing light green backpack with black canvas straps and front zipper pouch." class="h-full w-full object-cover object-center" />
      </div>
    </div>
